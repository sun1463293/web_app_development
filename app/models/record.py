...
def create_record(record_type, category, amount, date, description=""):
    ...
    try:
        ...
        print(f"Database error in create_record: {e}")
        return None
...
def get_all_records(order_by="date DESC"):
    ...
    try:
        ...
        print(f"Database error in get_all_records: {e}")
        return []
...
def get_record_by_id(record_id):
    ...
    try:
        ...
        print(f"Database error in get_record_by_id: {e}")
        return None
...
def update_record(record_id, record_type, category, amount, date, description=""):
    ...
    try:
        ...
        print(f"Database error in update_record: {e}")
        return False
...
def delete_record(record_id):
    ...
    try:
        ...
        print(f"Database error in delete_record: {e}")
        return False
...
def get_summary():
    ...
    try:
        ...
        print(f"Database error in get_summary: {e}")
        return {"income": 0, "expense": 0, "saving": 0, "balance": 0}
